...
const AboutPage = () => {
  ...
  const aboutData = {
    ...
    images: [
      ...
      getImageUrl('Mias', 'FEDE (4).jpg'),
      getImageUrl('Mias', 'FEDE (5).JPEG'),
    ]
  };
      ...
      <main className="relative z-20">
        ...
        <section className="container mx-auto max-w-7xl px-6 grid grid-cols-12 gap-x-6 gap-y-20 md:gap-y-32 pt-20">
          ...
          <div className={`${imageContBase} col-span-12 lg:col-span-5 h-[60vh] lg:h-full mt-12 lg:mt-0`}>
             <img loading="lazy" decoding="async" className={imgStyle} src={aboutData.images[1]} alt="Work 2" />
          </div>
...
const AboutHero = ({ category }) => {
  ...
  const currentImg = category?.images?.[currentImgIndex] || '';
